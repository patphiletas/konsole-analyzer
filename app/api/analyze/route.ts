    ...
    return toJsonResponse(
      createSuccessResponse({
        ...
        enrichment: {
          ...
          employees: wikiIntel.employees,
          headquarters: wikiIntel.headquarters,
          stockExchange: wikiIntel.stockExchange,
          parentOrg: wikiIntel.parentOrg,
          revenue: wikiIntel.revenue,
          netIncome: wikiIntel.netIncome,
        },
